...
class LumenNotificationsPublishCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'lumen-notifications:publish';
     ...
     * @var string
     */
    protected $description = "Publish any publishable assets from lumen-notifications package";
